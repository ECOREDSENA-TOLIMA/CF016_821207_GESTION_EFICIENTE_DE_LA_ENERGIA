...
.curso-main-container.pb-3.tema1
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-botones
      .titulo-principal__numero(style="background-color:#B3FFFF")
        span 1
      h1 Identificación de los Indicadores de Desempeño Energético (IDEn)

    .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5.mb-3(data-aos="flip-left")
      .bloque-texto-g__img(
    ...
    .row.mt-5.mb-4.align-items-stretch(data-aos="fade-right")
      .col-lg-4.col-md-12
        .tarjeta-avatar-b.mb-5
          ...
          .tarjeta.tarjeta--azul(style="background-color:#DBE6F5")
            .p-4
    ...
    .tarjeta.tarjeta--azul.p-4.mb-5.mt-5(style="background-color:#DBE6F5")
      SlyderA(tipo="b")
        .row.justify-content-center.align-items-center
          .col-md-6.mb-4.mb-md-0
    ...
    .tarjeta.tarjeta--azul.p-4.mb-5.mt-5(style="background-color:#DEFFFF")
      SlyderA(tipo="b")
        .row.justify-content-center.align-items-center
    ...
    .tarjeta.tarjeta--azul.p-4.mb-5.mt-5(style="background-color:#DBE6F5")
      SlyderA(tipo="b")
        ...
        .row.justify-content-center.align-items-center
          .col-md-5.mb-4.mb-md-0
            p  De acuerdo con la norma ISO 50001, a continuación se describen algunos de los usuarios más comunes identificados en las organizaciones:
            ul.lista-ul.mb-2
              li.mb-0
                i.fas.fa-angle-right 
